...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveKey() async {
    ...
    if (mounted) context.showSnackBar('Saved', color: AppTheme.success);
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'This will remove your Gemini API key from the app.',
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      _hasKey ? 'Configured' : 'Not configured',
                      style: theme.textTheme.bodySmall?.copyWith(
                        color: _hasKey ? AppTheme.success : AppTheme.error,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _hasKey ? AppTheme.success.withValues(alpha: 0.12) : AppTheme.error.withValues(alpha: 0.12),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Icon(
                  _hasKey ? Icons.check_rounded : Icons.close_rounded,
                  color: _hasKey ? AppTheme.success : AppTheme.error,
                  size: 18,
                ),
              ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: theme.textTheme.bodySmall?.copyWith(color: AppTheme.info),
                    ),
                  ),
                ],
              ),
